...
return [
    ...
    'category' => [
        'model'         => 'Cms_Framework_Seed\Block\Models\Category',
        'table'         => 'block_categories',
        'presenter'     => \Cms_Framework_Seed\Block\Repositories\Presenter\CategoryItemPresenter::class,
        'hidden'        => [],
        'visible'       => [],
        'guarded'       => ['*'],
        'slugs'         => ['slug' => 'name'],
    ...
    'block'    => [
        'model'         => 'Cms_Framework_Seed\Block\Models\Block',
        'table'         => 'blocks',
        'presenter'     => \Cms_Framework_Seed\Block\Repositories\Presenter\BlockItemPresenter::class,
        'hidden'        => [],
        'visible'       => [],
        'guarded'       => ['*'],
        'slugs'         => ['slug' => 'name'],
