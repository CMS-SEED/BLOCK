    ...
    public function run()
    {
        DB::table('blocks')->insert([
            ...
            ['category_id'  => '1',
                ...
                'order'         => '0',
                'description'   => 'Cms_Framework_Seed helps you to <a href="https://30hills.com/docs" target="_balnk">configure</a> your Laravel projects easily. It acts as a bootstrapper for your Laravel Content Management System.',
                'image'         => '',
            ...
            ['category_id'  => '1',
                ...
                'icon'          => 'fas fa-box',
                'order'         => '0',
                'description'   => 'The online package builder helps you to build <a href="https://30hills.com/packages" target="_balnk"> Cms_Framework_Seed packages</a> easily, The downloaded package with basic required files help you to finish your projects quickly.',
                'image'         => '',
        ...
        DB::table('block_categories')->insert([
            [
                ...
                'details'       => 'Visit our <a href="https://30hills.com/docs" target="_blank">documentation</a> for more information.',
                'status'        => 'show',
                'user_type'     => 'App\\User',
                'user_id'       => '1',
