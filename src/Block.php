...
class Block
{
     ...
     * Constructor.
     */
    public function __construct(\Cms_Framework_Seed\Block\Interfaces\CategoryRepositoryInterface $category,
        \Cms_Framework_Seed\Block\Interfaces\BlockRepositoryInterface $block) {
    ...
    public function count($module)
    {
        ...
        if (User::hasRole('user')) {
            $this->block->pushCriteria(new \Cms_Framework_Seed\Block\Repositories\Criteria\BlockUserCriteria());
        }
    ...
    public function getBlockCount($cid = null)
    {
        ...
        if (!empty($cid)) {
            return $this->block->pushCriteria(new \Cms_Framework_Seed\Block\Repositories\Criteria\BlockPublicCriteria())
