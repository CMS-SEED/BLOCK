...
class RouteServiceProvider extends ServiceProvider
{
     ...
     * @var string
     */
    protected $namespace = 'Cms_Framework_Seed\Block\Http\Controllers';
    ...
    public function boot()
    {
        ...
        if (Request::is('*/block/block/*')) {
            Route::bind('block', function ($block) {
                $blockrepo = $this->app->make('Cms_Framework_Seed\Block\Interfaces\BlockRepositoryInterface');
        ...
        if (Request::is('*/block/category/*')) {
            Route::bind('category', function ($category) {
                $categoryrepo = $this->app->make('Cms_Framework_Seed\Block\Interfaces\CategoryRepositoryInterface');
