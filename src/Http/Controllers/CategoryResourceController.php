...
use Cms_Framework_Seed\Block\Http\Requests\CategoryRequest;
use Cms_Framework_Seed\Block\Interfaces\CategoryRepositoryInterface;
use Cms_Framework_Seed\Block\Models\Category;
...
class CategoryResourceController extends BaseController
{
    ...
    public function __construct(CategoryRepositoryInterface $category)
    {
        ...
        $this->repository
            ...
            ->pushCriteria(\Cms_Framework_Seed\Block\Repositories\Criteria\CategoryResourceCriteria::class);
    }
    ...
    public function index(CategoryRequest $request)
    {
        ...
        if ($this->response->typeIs('json')) {
            ...
            $data      = $this->repository
                ->setPresenter(\Cms_Framework_Seed\Block\Repositories\Presenter\CategoryListPresenter::class)
