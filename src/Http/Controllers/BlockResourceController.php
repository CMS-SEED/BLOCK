...
use Cms_Framework_Seed\Block\Http\Requests\BlockRequest;
...
class BlockResourceController extends BaseController
{
    ...
    public function __construct(BlockRepositoryInterface $block)
    {
        ...
        $this->repository
            ...
            ->pushCriteria(\Cms_Framework_Seed\Block\Repositories\Criteria\BlockResourceCriteria::class);
    }
    ...
    public function index(BlockRequest $request)
    {
        ...
        if ($this->response->typeIs('json')) {
            ...
            $data      = $this->repository
                ->setPresenter(\Cms_Framework_Seed\Block\Repositories\Presenter\BlockListPresenter::class)
